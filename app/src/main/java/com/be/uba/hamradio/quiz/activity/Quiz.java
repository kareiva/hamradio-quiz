...
import com.be.uba.hamradio.quiz.App;
import com.be.uba.hamradio.quiz.Config;
import com.be.uba.hamradio.quiz.R;
import com.be.uba.hamradio.quiz.fragment.FlashcardFragment;
import com.be.uba.hamradio.quiz.fragment.MultipleChoiceFragment;
import com.be.uba.hamradio.quiz.fragment.QuestionFragment.QuestionListener;
import com.be.uba.hamradio.quiz.model.DataSource;
import com.be.uba.hamradio.quiz.model.Question;
import com.be.uba.hamradio.quiz.util.SoundPoolAssistant;
import com.be.uba.hamradio.quiz.util.Task;
...
public class Quiz extends RoboFragmentActivity implements QuestionListener {
	...
	private String getProgressText() {
		return String.format("Vraag %d van %d", mQuestionIndex + 1,
				mQuestions.length);
	}
	...
	private String getScoreText() {
		...
		return String.format("%d van %d juist (%d%%)", mNumCorrect,
				mNumAnswered, pct);
	}
