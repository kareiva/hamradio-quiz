package com.ee.erau.hamradio.quiz.activity;
...
import com.ee.erau.hamradio.quiz.App;
import com.ee.erau.hamradio.quiz.Config;
import com.ee.erau.hamradio.quiz.R;
import com.ee.erau.hamradio.quiz.fragment.FlashcardFragment;
import com.ee.erau.hamradio.quiz.fragment.MultipleChoiceFragment;
import com.ee.erau.hamradio.quiz.fragment.QuestionFragment.QuestionListener;
import com.ee.erau.hamradio.quiz.model.DataSource;
import com.ee.erau.hamradio.quiz.model.Question;
import com.ee.erau.hamradio.quiz.util.SoundPoolAssistant;
import com.ee.erau.hamradio.quiz.util.Task;
...
public class Quiz extends RoboFragmentActivity implements QuestionListener {
	...
	private String getProgressText() {
		return String.format("Küsimus: %d/%d", mQuestionIndex + 1,
				mQuestions.length);
	}
	...
	private String getScoreText() {
		...
		return String.format("Õigeid vastuseid: %d/%d (%d%%)", mNumCorrect,
				mNumAnswered, pct);
	}
